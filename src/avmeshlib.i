...
%rename(unstruc_read_cells_nosize)  avm_unstruc_read_cells_nosize;
%rename(unstruc_read_partial_cells) avm_unstruc_read_partial_cells;
%rename(unstruc_read_partial_cells_nosize) avm_unstruc_read_partial_cells_nosize;
...
extern int avm_unstruc_read_faces(int, int*, int, int*, int);
extern int avm_unstruc_read_tri(int, int*, int, int, int, int, int);
extern int avm_unstruc_read_quad(int, int*, int, int, int, int, int);
extern int avm_unstruc_read_partial_faces(int, int*, int, int, int, int*, int, int, int);
extern int avm_unstruc_read_bnd_faces(int, int*, int, int*, int);
extern int avm_unstruc_read_cells_nosize(int, int*, int*, int*, int*);
extern int avm_unstruc_read_cells(int, int*, int, int*, int, int*, int, int*, int);
extern int avm_unstruc_read_partial_cells_nosize(int, int*, int, int, int*, int, int, int*, int, int, int*, int, int);
