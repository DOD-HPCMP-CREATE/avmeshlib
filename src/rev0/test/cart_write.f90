program cart_write
   ...
   integer :: avmid, istat, avmeshRev=0
   character*256 :: str
 ...
 !
   ...
   call avm_set_strf(avmid, 'contactName', 'Andy Wissink', istat)
   call avm_set_strf(avmid, 'contactOrg', 'NASA Ames', istat)
   call avm_set_strf(avmid, 'contactEmail', 'awissink@mail.arc.nasa.gov', istat)
   ...
   call avm_set_strf(avmid, 'changedDate', 'May 7, 2010', istat)
