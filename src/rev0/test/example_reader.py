...
for i in xrange(1, meshCount+1):
   ...
   if type == 'bfstruc':
      err, jmax = avmesh.get_int(avmid, 'jmax')
      err, kmax = avmesh.get_int(avmid, 'kmax')
      err, lmax = avmesh.get_int(avmid, 'lmax')
      # ...
   elif type == 'strand':
      ...
      err, nLevels = avmesh.get_int(avmid, 'nLevels')
      err, nBlocks = avmesh.get_int(avmid, 'nBlocks')
      err, nFringe = avmesh.get_int(avmid, 'nFringe')
      # ...
