#ifndef STRAND_REV0_DEFS
#define STRAND_REV0_DEFS

/** @page strand_rev0 Strand Data Format
...
<pre>
   write(iu)((triConn(k,n),k=1,3),n=1,nTriFaces)
   write(iu)((quadConn(k,n),k=1,4),n=1,nQuadFaces)
   write(iu)((bndEdges(k,n),k=1,2),n=1,nBndEdges)
   write(iu)(nodeClip(n),n=1,nSurfNodes)
   write(iu)(faceClip(n),n=1,nTriFaces+nQuadFaces)
   write(iu)(faceTag(n),n=1,nTriFaces+nQuadFaces)
   write(iu)(edgeTag(n),n=1,nBndEdges)
   write(iu)((xSurf(k,n),k=1,3),n=1,nSurfNodes)
   write(iu)((pointingVec(k,n),k=1,3),n=1,nSurfNodes)
